...
#define PVR2D_VERTEXDATA_X 0
#define PVR2D_VERTEXDATA_Y 1
#define PVR2D_VERTEXDATA_TEXU0 2
#define PVR2D_VERTEXDATA_TEXV0 3
#define PRV2D_VERTEXDATA_TEXU1 4
#define PVR2D_VERTEXDATA_TEXV1 5
...
typedef struct _PVR2DBLTINFO
{
	...
	unsigned long	ColourKey;			/* colour key argb8888 (see CKEY_ defs below) */
	unsigned long	ColourKeyMask;		/* colour key mask, a 1 indicates the bit is used in the key test */
...
typedef struct
{
	...
	unsigned long	Format3D;			/* special 3D-only format (NULL implies none) */
...
typedef struct
{
	...
	unsigned long			UseParams[2];				/* per-blt params for usse code */
	unsigned int			uiNumTemporaryRegisters;	/* no. of temporary registers used in custom shader code */
...
#define PVR2D_CREATE_FLIPCHAIN_OEMOVERLAY   (1 << 2)

/* Colour-key colours must be translated into argb8888 format */
#define CKEY_8888(P)		(P)
#define CKEY_4444(P)		(((P&0xF000)<<16) | ((P&0x0F00)<<12) | ((P&0x00F0)<<8) | ((P&0x000F)<<4))
#define CKEY_1555(P)		(((P&0x8000)<<16) | ((P&0x7C00)<<9)  | ((P&0x3E0)<<6)  | ((P&0x1F)<<3))
#define CKEY_565(P)			(((P&0xF800)<<8)  | ((P&0x7E0)<<5)   | ((P&0x1F)<<3))
#define CKEY_MASK_8888		0x00FFFFFF
#define CKEY_MASK_4444		0x00F0F0F0
#define CKEY_MASK_1555		0x00F8F8F8
#define CKEY_MASK_565		0x00F8FCF8
...
/* This can be passed to 'PVR2DSyncEventReq' as 'type' */
#define PVR2D_WAIT_SYNC_EVENT 0x1000000

PVR2DERROR PVR2DSyncEventReq(PVR2DCONTEXTHANDLE hContext,
				PVR2DMEMINFO *pMemInfo, void *hUserData,
				unsigned int type);
PVR2DERROR PVR2DFlipEventReq(PVR2DCONTEXTHANDLE hContext,
				unsigned int overlay, void *hUserData);
PVR2DERROR PVR2DUpdateEventReq(PVR2DCONTEXTHANDLE hContext,
				unsigned int overlay, void *hUserData);

PVR2D_IMPORT int PVR2DGetFileHandle(PVR2DCONTEXTHANDLE hContext);
...
#define PVR2D_CFLUSH_FROM_GPU		1
#define PVR2D_CFLUSH_TO_GPU			2
