...
static inline int time_after_eq(unsigned long t1, unsigned long t2)
{
	return (int)(t1 - t2) >= 0;
}

static inline int sync_cnt_after_eq(IMG_UINT32 c1, IMG_UINT32 c2)
{
	return time_after_eq(c1, c2);
}
